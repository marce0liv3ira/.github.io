...
<body>
    ...
    <script>
        ...
        function copiarAlPortapapeles() {{
            ...
            const e = document.getElementById('modEdi').innerText;
            const n = document.getElementById('modAño').innerText;
            const txt = `Quiero este libro: "${{t}}" de "${{a}}" ("${{e}}", "${{n}}").`;
        ...
        function volverArriba() {{ document.getElementById('menu-selector').scrollIntoView({{ behavior: 'smooth' }}); }}
    </script>
</body>
</html>
"""
